...
const Page = () => {
  ...
  return (
    <div>
      ...
      <section id="main-section" className="main-section bg-gray-100 py-16">
  ...
  {/* Box 3 */}
  <a
  href="https://frontend-v1-1-ggzw.onrender.com/"
  target="_blank"
    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="https://otgongunj.com/" className="flex items-center">
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Mining_GEE</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li className="mb-4">
                          <a href="https://www.researchgate.net/publication/354109655_REMOTE_SENSING_TECHNIQUES_FOR_IDENTIFICATION_OF_MINERAL_DEPOSIT/" className="hover:underline">Researchgate</a>
                      </li>
                      <li className="mb-4">
                          <a href="https://www.sciencedirect.com/science/article/pii/S2352938524001800/" className="hover:underline">Sciencedirect</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/Astridtu/Mining_GEE" className="hover:underline ">Github</a>
                      </li>
                      <li>
                          <a href="https://www.facebook.com/lkhagvaa2444" className="hover:underline">Facebook</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a className="hover:underline">Mining_GEE™</a>. All Rights Reserved.
          </span>
